...
<html lang="pt-br">
  <head>
    ...
    <title>Cheaplothes Camisetas</title>
    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="camisetas.php" id='ativo' class="nav-link px-2 link-secondary li"> Camisetas </a></li>
      ...
      <div class="container">
        <div class="row">
          ...
          <img src="camisetaExemplo.jpg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">R$ 149,99</h5>
            <p class="card-text">Camisa Nike Corinthians I 2021/22 Jogador Masculino</p>
