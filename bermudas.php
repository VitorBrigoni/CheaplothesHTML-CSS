...
<html lang="pt-br">
  <head>
    ...
    <title>Cheaplothes Bermudas</title>
  ...
  <header class="p-3 mb-3 border-bottom">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          ...
          <li><a href="bermudas.php" id='ativo' class="nav-link px-2 link-dark">Bermudas</a></li>
    ...
    <div class="container">
        <div class="row">
          ...
          <img src="bermudaExemplo.jpg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">R$ 129,99</h5>
            <p class="card-text">Shorts Nike Dri-Fit Corinthians Masculino</p>
