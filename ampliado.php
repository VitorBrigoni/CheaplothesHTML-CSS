  ...
  <head>
    ...
    <style>
      ...
      body, html{
        ...
        input[type=radio]:checked + label .tam1 {
            border: 2px solid green;
            background: lightgreen;
            color:white;
        }
        input[type=radio]:checked + label .tam2 {
            border: 2px solid green;
            background: lightgreen;
            color:white;
        }
        input[type=radio]:checked + label .tam3 {
            border: 2px solid green;
            background: lightgreen;
            color:white;
        }
        input[type=radio]:checked + label .tam4 {
            border: 2px solid green;
            background: lightgreen;
            color:white;
        }
        input[type=radio]:checked + label .tam5 {
            border: 2px solid green;
            background: lightgreen;
            color:white;
        }
  ...
  <header class="p-3 mb-3 border-bottom">
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content justify-content-lg-start">
        <a class="navbar-brand"><h1 class='site'>CHEAPLOTHES</h1></a>
    ...
    <div class='container'> 
        <div class='row ampliado'>
            ...
            <div class='col'>
                    ...
                    <input type="radio" name="size" id="tam1" value="pp" />
                    <label for="tam1"><span class="tam1 rounded-circle"><p>PP</p></span></label>

                    <input type="radio" name="size" id="tam2" value="p" />
                    <label for="tam2"><span class="tam2 rounded-circle"><p>P</p></span></label>

                    <input type="radio" name="size" id="tam3" value="m" />
                    <label for="tam3"><span class="tam3 rounded-circle"><p>M</p></span></label>

                    <input type="radio" name="size" id="tam4" value="g" />
                    <label for="tam4"><span class="tam4 rounded-circle"><p>G</p></span></label>

                    <input type="radio" name="size" id="tam5" value="gg" />
                    <label for="tam5"><span class="tam5 rounded-circle"><p>GG</p></span></label><br>
